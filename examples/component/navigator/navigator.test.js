...
const PAGE_PATH = '/examples/component/navigator/navigator'
const PAGE_PATH_NAVIGATE = '/examples/component/navigator/navigate'
const PAGE_PATH_REDIRECT = '/examples/component/navigator/redirect'
