...
describe('component-native-image', () => {
  ...
  beforeAll(async () => {
    page = await program.reLaunch('/examples/component/image/image');
  ...
  if (!isAppWebView) {
    it('path-screenshot', async () => {
      const page = await program.navigateTo('/examples/component/image/image-path');
  ...
  it('mode-screenshot', async () => {
    ...
    const page = await program.navigateTo('/examples/component/image/image-mode');
    await page.waitFor(3000);
    const image = await program.screenshot(screenshotParams)
    expect(image).toSaveImageSnapshot()
  });
  ...
  it('long-path-screenshot', async() => {
    ...
    const page = await program.navigateTo('/examples/component/image/image-long');
    await page.waitFor(3000);
    const image = await program.screenshot(screenshotParams)
    expect(image).toSaveImageSnapshot()
  })
