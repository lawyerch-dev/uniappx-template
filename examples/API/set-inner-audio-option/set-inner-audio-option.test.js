...
describe('/examples/API/set-inner-audio-option/set-inner-audio-option', () => {
  ...
  let page;
  beforeAll(async () => {
    page = await program.reLaunch('/examples/API/set-inner-audio-option/set-inner-audio-option')
