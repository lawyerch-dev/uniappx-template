const PAGE_PATH = "/examples/API/navigator/new-page/onLoad";
const INTERMEDIATE_PAGE_PATH = "/examples/API/navigator/new-page/new-page-1";
const TARGET_PAGE_PATH = "/examples/API/navigator/new-page/new-page-3";
...
describe("onLoad", () => {
  ...
  it("switchTab", async () => {
    ...
    await page.waitFor(100);
    page = await program.currentPage();
    expect(page.path).toBe("examples/tabBar/component");
  });
  }
  it("showToast", async () => {
    page = await program.reLaunch(INTERMEDIATE_PAGE_PATH);
