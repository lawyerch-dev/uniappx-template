...
describe('/examples/template/list-delete-swipe-batch/list-delete-swipe-batch.uvue', () => {
  ...
  let page;
  beforeAll(async () => {
    page = await program.reLaunch('/examples/template/list-delete-swipe-batch/list-delete-swipe-batch')
