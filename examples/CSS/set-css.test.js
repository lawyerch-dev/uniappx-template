...
describe('set css', () => {
  ...
  const sharedCssTests = [
    {
      path: "/examples/CSS/layout/width",
    ...
    {
      path: "/examples/CSS/layout/min-width",
    ...
    {
      path: "/examples/CSS/layout/max-width",
    ...
    {
      path: "/examples/CSS/layout/height",
    ...
    {
      path: "/examples/CSS/layout/min-height",
    ...
    {
      path: "/examples/CSS/layout/max-height",
    ...
    {
      path: "/examples/CSS/layout/visibility",
    ...
    {
      path: "/examples/CSS/layout/bottom",
    ...
    {
      path: "/examples/CSS/layout/right",
    ...
    {
      path: "/examples/CSS/layout/position",
    ...
    {
      path: "/examples/CSS/border/border-style",
    ...
    {
      path: "/examples/CSS/border/border-width",
    ...
    {
      path: "/examples/CSS/box-sizing/box-sizing",
    ...
    {
      path: "/examples/CSS/display/flex",
    ...
    {
      path: "/examples/CSS/display/none",
      method: "radioChangeDisplay",
      valueIndex: 2,
      styleName: "display",
      expectedValue: {
    ...
    {
      path: "/examples/CSS/flex/flex-direction",
    ...
    {
      path: "/examples/CSS/flex/justify-content",
    ...
    {
      path: "/examples/CSS/flex/align-content",
    ...
    {
      path: "/examples/CSS/flex/align-items",
    ...
    {
      path: "/examples/CSS/flex/flex-basis",
    ...
    {
      path: "/examples/CSS/flex/flex-grow",
    ...
    {
      path: "/examples/CSS/flex/flex-shrink",
    ...
    {
      path: "/examples/CSS/flex/align-self",
    ...
    {
      path: "/examples/CSS/flex/flex-wrap",
    ...
    {
      path: "/examples/CSS/margin/margin-bottom",
    ...
    {
      path: "/examples/CSS/margin/margin-left",
    ...
    {
      path: "/examples/CSS/margin/margin-right",
    ...
    {
      path: "/examples/CSS/margin/margin-top",
    ...
    {
      path: "/examples/CSS/padding/padding-bottom",
    ...
    {
      path: "/examples/CSS/padding/padding-left",
    ...
    {
      path: "/examples/CSS/padding/padding-right",
    ...
    {
      path: "/examples/CSS/padding/padding-top",
    ...
    {
      path: "/examples/CSS/text/text-align",
    ...
    {
      path: "/examples/CSS/text/font-family",
    ...
    {
      path: "/examples/CSS/text/font-size",
    ...
    {
      path: "/examples/CSS/text/font-weight",
    ...
    {
      path: "/examples/CSS/text/text-decoration-line",
    ...
    {
      path: "/examples/CSS/text/text-overflow",
    ...
    {
      path: "/examples/CSS/text/letter-spacing",
    ...
    {
      path: "/examples/CSS/text/line-height",
    ...
    {
      path: "/examples/CSS/text/white-space",
    ...
    {
      path: "/examples/CSS/text/font-style",
    ...
    {
      path: "/examples/CSS/transform/rotate",
    ...
    {
      path: "/examples/CSS/transform/transform-origin",
    ...
    {
      path: "/examples/CSS/transform/translate",
      method: "radioChangeTransform",
      valueIndex: 4,
      styleName: "transform",
      expectedValue: {
    ...
    {
      path: "/examples/CSS/transition/transition-delay",
  ...
  const splitCssTests = [
    {
      path: "/examples/CSS/layout/opacity",
    ...
    {
      path: "/examples/CSS/layout/z-index",
    ...
    {
      path: "/examples/CSS/background/background-color",
    ...
    {
      path: "/examples/CSS/border/border",
    ...
    {
      path: "/examples/CSS/border/border-radius",
    ...
    {
      path: "/examples/CSS/border/border-color",
    ...
    {
      path: "/examples/CSS/border/border-top",
    ...
    {
      path: "/examples/CSS/border/border-bottom",
    ...
    {
      path: "/examples/CSS/border/border-left",
    ...
    {
      path: "/examples/CSS/border/border-right",
    ...
    {
      path: "/examples/CSS/box-shadow/box-shadow",
    ...
    {
      path: "/examples/CSS/flex/flex-flow",
    ...
    {
      path: "/examples/CSS/margin/margin-auto",
    ...
    {
      path: "/examples/CSS/margin/margin",
      method: "radioChangeMargin",
      valueIndex: 3,
      styleName: "margin",
      expectdom2: {
    ...
    {
      path: "/examples/CSS/padding/padding",
    ...
    {
      path: "/examples/CSS/text/text-shadow",
    ...
    {
      path: "/examples/CSS/transform/scale",
      method: "radioChangeTransform",
      valueIndex: 2,
      styleName: "transform",
      expectdom2: {
    ...
    {
      path: "/examples/CSS/transition/transition-timing-function",
